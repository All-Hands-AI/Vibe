...
class TestRiffsEndpoints:
    ...
    def setup_app_for_riffs(self, client, sample_headers, mock_api_keys, app_name="Test App"):
    ...
    def test_create_riff_missing_name(self, client, sample_headers, mock_api_keys):
    ...
    def test_create_riff_empty_name(self, client, sample_headers, mock_api_keys):
    ...
    def test_different_users_isolated_riffs(self, client, mock_api_keys):
        ...
        app1_slug = self.setup_app_for_riffs(client, user1_headers, mock_api_keys, "User1 App")
        app2_slug = self.setup_app_for_riffs(client, user2_headers, mock_api_keys, "User2 App")
    ...
    def test_riffs_different_apps_same_user(self, client, sample_headers, mock_api_keys):
        """Test that riffs are isolated between different apps for the same user"""
        # Create two apps
        app1_slug = self.setup_app_for_riffs(client, sample_headers, mock_api_keys, "App One")
        app2_slug = self.setup_app_for_riffs(client, sample_headers, mock_api_keys, "App Two")
