...
function Button({ 
  ...
  const variantClasses = {
    primary: 'bg-primary-300 text-gray-900 hover:bg-primary-400 focus:ring-primary-300 shadow-lg hover:shadow-xl hover:-translate-y-0.5',
    secondary: 'bg-transparent text-primary-300 border-2 border-primary-300 hover:bg-primary-300 hover:text-gray-900 focus:ring-primary-300',
