...
function AppStatus({ app }) {
  ...
  return (
    <div className="hacker-card">
      <div className="mb-6">
        <h3 className="text-xl font-semibold text-cyber-text mb-4 font-mono">App Status</h3>
        
        {/* PR Status Section */}
        <div className="mb-6">
          <h4 className="text-lg font-medium text-cyber-text mb-3 font-mono">Pull Request Status</h4>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <span className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium font-mono border ${getStatusColor(prData.ci_status)}`}>
                    {getStatusIcon(prData.ci_status)} {getStatusText(prData.ci_status)}
                  </span>
                </div>

                {/* Individual Check Commits */}
        ...
        <div>
          <h4 className="text-lg font-medium text-cyber-text mb-3 font-mono">Deployment Status</h4>
